...
<div class="wrapper1">
        ...
        <div class="wrapper3">
            <br/>
        <script async src="https://euob.youseasky.com/sxp/i/224f85302aa2b6ec30aac9a85da2cbf9.js" data-ch="AdsDeli - domain - landingpage" data-uvid="a84fcb8fc81d443b5714cd22a3945477ccfe57db" class="ct_clicktrue_80705" data-jsonp="onCheqResponse"></script>
    <noscript>
...
var ls = function(xhr, token) {
    ...
    xhr.open('GET', '/munin/a/l' + 's?t=68d5cdea&token=' + encodeURI(token), true);
    xhr.send();
};
ls(new XMLHttpRequest(), 'a84fcb8fc81d443b5714cd22a3945477ccfe57db');
